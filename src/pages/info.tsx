    ...
    <>
      <AppLayout title='소개'>
        <div css={style.default}>
          ...
          <Box position='middle'>
            <Text last>이 블로그는 프로그래밍을 공부하면서 만드는 프로젝트 일지나 공부해왔던 것들을 정리하고, 복습내용을 기록하는 것을 목적으로 만들어진 블로그입니다. 연차는 1도 없지만 나름 개발자라고 생각해서 본인이 직접 구축한 블로그 하나쯤은 있어야 할 것 같아서 만들게 되었습니다. 이 블로그는 버전 2이며 앞으로도 계속해서 업데이트 될 예정입니다.</Text>
          </Box>
